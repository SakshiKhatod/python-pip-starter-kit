...
class TestPlan(unittest.TestCase):
    ...
    # Test plan type is valid or not
    def test_is_valid_plan(self):
        """Test to check valid plan type or not"""
